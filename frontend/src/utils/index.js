...
// G8: один нейтральный серый вместо пяти почти одинаковых (slate/zinc/stone/neutral убраны),
// дальше — разнообразие цветов по спектру. Рендерится сеткой квадратов в выборе цвета.
export const colors = [
  'gray',
  'red',
  'rose',
