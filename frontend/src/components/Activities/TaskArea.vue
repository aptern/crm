        ...
        <div class="flex flex-1 flex-col gap-1.5 text-base truncate">
          ...
          <div class="flex gap-1.5 text-ink-gray-8">
            ...
            <div v-if="task.due_date">
              <Tooltip
                :text="formatDate(task.due_date, TASK_DATETIME_FORMAT)"
              >
                <div class="flex gap-2">
                  <CalendarIcon />
                  <div>{{ formatDate(task.due_date, TASK_DATE_SHORT_FORMAT) }}</div>
                </div>
              </Tooltip>
            </div>
...
import { formatDate, taskStatusOptions, TASK_DATETIME_FORMAT, TASK_DATE_SHORT_FORMAT } from '@/utils'
